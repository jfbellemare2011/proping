...
#The sendmail  mode, "on" "off", allows to start or stop sending warning mail of telecommunication network problems tcp/ip, by the processus ( /usr/lib/sendmail ).
...
D)sendmail_mode = off
E)sendmail_to = user@localhost,user2@gmail.com
F)sendmail_from = user@localhost
G)sendmail_subject = The_communication_network_tcp/ip_is_interrupted
I)sendmail_mta_server_host = localhost
J)sendmail_mta_server_port = 25
