...
# hosts to ./proping.conf
VAR=(`cat $FILE_IN | grep -v ':\|#' | grep \t | awk '{$1000="*_";$1001="="; print $1000,$2,$1001,$1 }' >> ./proping.conf`)
...
echo "The address DNS of /etc/hosts has been converted to (./proping.conf)!"
