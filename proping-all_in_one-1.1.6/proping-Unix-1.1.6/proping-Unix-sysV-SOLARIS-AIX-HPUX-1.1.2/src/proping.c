...
printf("Please wait for a maximum of 2min, the time to finish traceroute analysis!!!\n\n\n");
...
strcat(trace_command_strcat, "traceroute -m 15 "); //---Concatenate for ping command;
strcat(trace_command_strcat, option_argument); //---Concatenate for traceroute command
strcat(trace_command_strcat, " > tmptrace.txt "); //---Concatenate for ping command;
